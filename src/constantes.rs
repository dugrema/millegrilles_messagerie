...
pub const NOM_COLLECTION_FICHIERS_REP: &str = "Messagerie/fichiersRep";
pub const NOM_COLLECTION_VERSIONS: &str = "Messagerie/versionsFichiers";
pub const NOM_COLLECTION_DOCUMENTS: &str = "Messagerie/documents";
